...
class MinPathPlugin:
    ...
    def output(self, outputfile):
        minpath = PyPluMA.prefix()+"/../"#os.path.dirname(os.path.abspath(sys.argv[0]))
        ...
        kofile, ecfile, figfile, anyfile, mapfile, mpsfile, reportfile, detailfile = self.inputfile, "", "", "", "", "test.mps", outputfile, ""
